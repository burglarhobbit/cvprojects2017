![ConceptMap](./images/cv*_concept.jpg)
# Computer Vision
...
[Report](./CIMC/CV*_Report*_CIMC.pdf) | [PPT](./CIMC/CV*_PPT*_CIMC.pptx)
...
*_Bhavya Patwa, Deval Shah, Karan Patel, Parth Shah_*

### Video Tagging
[Report](./DBProgrammers/CV*_Report*_DBProgrammers.pdf) | [PPT](./DBProgrammers/CV*_PPT*_DBProgrammers.pdf)
...
*_Varad Bhogayata, Ratnesh Shah, Prerak Raja, Madhav Chavda_*

### Hand Gesture Recognition
[Report](./TheWildCards/CV*_Report*_TheWildCards.pdf) | [PPT](./TheWildCards/CV*_PPT*_TheWildCards.pptx)
...
*_Akash Soni, Kashish Shah, Raj Shah_*

### Traffic Management using Pattern and Surrounding Analysis
[Report](./Videre/CV*_Report*_Videre.pdf) | [PPT](./Videre/CV*_PPT*_Videre.pptx)
...
*_Aashima Yuthika, Deep Patel, Divya Patel, Maunil Vyas_*

### Estimating Pulse Rate using facial video recording
[Report](./JAR/CV*_Report*_JAR.pdf) | [PPT](./JAR/CV*_PPT*_JAR.pptx)

Given a facial video recording, the task is to estimate pulse rate using non contact techniques. The concepts include computer vision, facial recognition and detection and signal processing techniques.

*_Aneri Sheth, Janki Desai, Rupande Shastri_*
